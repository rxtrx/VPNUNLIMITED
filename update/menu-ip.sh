...
NC="\e[0m"
COLOR1="$(cat /etc/serigala/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
COLBG1="$(cat /etc/serigala/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"

APIGIT=$(cat /etc/serigala/github/api)
EMAILGIT=$(cat /etc/serigala/github/email)
USERGIT=$(cat /etc/serigala/github/username)
...
if [[ -f /etc/serigala/github/api && -f /etc/serigala/github/email && /etc/serigala/github/username ]]; then
   rec="OK"
else
    mkdir /etc/serigala/github > /dev/null 2>&1
fi
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • HARIMAU V3 •            $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e ""
...
sleep 2
echo "$EMAIL1" > /etc/serigala/github/email
echo "$USERNAME1" > /etc/serigala/github/username
echo "$API1" > /etc/serigala/github/api
echo "ON" > /etc/serigala/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
function resetipvps(){
clear
rm -f /etc/serigala/github/email
rm -f /etc/serigala/github/username
rm -f /etc/serigala/github/api
rm -f /etc/serigala/github/gitstat
echo "OFF" > /etc/serigala/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1│${NC} [INFO] PM : t.me/Nizam_KK/"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • HARIMAU V3 •            $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/serigala/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/serigala/github
    touch /etc/serigala/github/gitstat
    echo "OFF" > /etc/serigala/github/gitstat
fi

stst1=$(cat /etc/serigala/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
stst=$(cat /etc/serigala/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
